...
Rectangle {
    ...
    property string perimetreDescriptionModifyText: ""
    property string perimetreNameModifyText: ""
    property string perimetreIDModifyText: ""
    id: dialogBoxModify
    width: 428
    height: 292
    color: "#f6f6f6"
    ...
    TextField {
        ...
        width: 346
        height: 38
        text: dialogBoxModify.perimetreNameModifyText
    ...
    ScrollView {
        ...
        TextArea {
            ...
            height: 95
            padding: 10
            text: dialogBoxModify.perimetreDescriptionModifyText
            font.family: "Ubuntu Light"
            font.pointSize: 10
            ...
            Connections {
                ...
                onClicked: {
                    ...
                    if(perimetreDescription.text==="" || perimetreDescription.text===""){
                        ...
                        buttonClicked("modifier",perimetreName.text,perimetreDescription.text);
                    }
                }
            }
            cursorShape: Qt.PointingHandCursor
